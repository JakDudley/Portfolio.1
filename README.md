...
![screenshot of responsive website](/docs/images/responsive.png) 
...
![Picture of each page title in the window tab](docs/images/title-tabs.png)
...
![old nav bar screenshot](docs/images/old-navbar.jpg)
---
...
![navbar screenshot](docs/images/new-navbar-ss.png)
...
![navbar with hover](docs/images/new-navbar-hover.jpg)
...
Within the marketing industry repetition is a key factor, reminding the customer how they can get in touch is a key factor to improving the chances of the user getting in contact and using the product, in this case visiting the restaurant.
  ...
  ![hero image display](docs/images/hero-image-sc.jpg) 
...
![footer hover](docs/images/footer-hover.png)
...
![Screenshot of menu page](docs/images/menu-page.png)
...
![Screenshot of review page](docs/images/remove-js.png)
...
![Screenshot of contact page](docs/images/contact-us.png)
![Screenshot of iframe on contact page](docs/images/iframe.png)
...
- [x] Textarea
- [x] Option
![Screenshot of reserve page](docs/images/reserve-page.png)
